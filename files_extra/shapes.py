...
shapes_word=open("C://Users/HP/Desktop/Mini Project Python/264673_MiniProject_Python/files_extra//shapes_word.txt", "r")
SHAPES_WORD = list(shapes_word.readline().split(","))
shapes_ans=open("C://Users/HP/Desktop/Mini Project Python/264673_MiniProject_Python/files_extra//shapes_answer.txt", "r")
SHAPES_ANSWER = list(shapes_ans.readline().split(","))
